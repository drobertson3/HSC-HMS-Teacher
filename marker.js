...
const Marker = (() => {
  ...
  const SYSTEM = `You are an experienced NESA HSC Health and Movement Science marker at a marking centre.
...
- strengths / improvements: up to 3 short dot-point style phrases each`;
  ...
  function buildUserContent(q, qImg, student){
    ...
    content.push({ type: 'text', text:
      (q.year ? `QUESTION: ${q.year} HSC PDHPE, Question ${q.n}${q.part ? '(' + q.part + ')' : ''} — worth ${q.marks} mark${q.marks === 1 ? '' : 's'}. Topic: ${q.topic}.`
